...
|:-|:-|:-|:-|:-|
|函数参数传递|栈(push为主)|寄存器(%rsi等)优先<br>设置%eax(参考资料1)|栈(mov为主)|寄存器(%rsi等)优先<br>设置%eax(参考资料1)|
...
- [参考资料1](https://stackoverflow.com/questions/6212665/why-is-eax-zeroed-before-a-call-to-printf)
